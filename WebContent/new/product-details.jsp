...
<body>
	...
	<div class="small-container single-product">
		<div class="row">
			<div class="col-2">
				<img src="images/billie-eilish/be.png" class="uniform-img" width="100%"
					id="product-img">

				<div class="small-img-row">
					<div class="small-img-col">
						<img src="images/billie-eilish/be.png" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/billie-eilish/bet2.png" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/billie-eilish/bet3.png" width="100%" class="small-img">
					</div>
				</div>
			...
			<div class="col-2">
				<p>Home / Billie Eilish</p>  <!-- il nome dell'artista deve cambiare, forse anche il path: home/products/billie Eilish (?) -->
				<h1>Hit me Hard and Soft Tour</h1>
				<h4>50$</h4>
				<h3>Stadio Maradona</h3>
				<div class="button-group">
					...
					<div id="imageOverlay" class="overlay">
						<span class="close-btn">&times;</span> <img id="fullscreenImage"
							class="overlay-image" src="images/stadi/maradona.png"> <!-- da cambiare in base allo stadio -->
					</div>
				...
				<a href="cart.html" class="btn">Aggiungi al carrello</a>
